...
\begin{frame}
    ...
    \begin{figure}[t]
        ...
        \begin{tikzpicture}[node distance=0.6cm]
            ...
            \node (fabrication2) [transition, below of=enrichment2,yshift=-0.5cm]{\tiny Fuel Fabrication};
            \node (fabrication) [facility, below of=enrichment, yshift=-0.5cm]{\tiny Fuel Fabrication};
            \node (reactor) [facility, below of=fabrication]{\tiny LWR};
