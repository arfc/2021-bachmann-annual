...
The first scenario simulates just the current fleet of U.S. reactors. This 
...
which have been condensed to one facility in the diagram. the facilities
red are used only in the transition scenarios to provide a spearate 
material stream. 
